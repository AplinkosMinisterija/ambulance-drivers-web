...
import { MdArrowBack, MdExitToApp, MdKeyboardArrowDown, MdList, MdTune } from 'react-icons/md';
...
const Icon = ({ name, className }: IconProps) => {
  switch (name) {
    ...
    case 'logo':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="67.305" height="40" viewBox="0 0 67.305 40">
